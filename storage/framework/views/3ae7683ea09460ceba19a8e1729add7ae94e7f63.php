    ...
    <div id="page" class="site">
      <div class="container">
        <div class="form-box">
          ...
          <form action="<?php echo e(route('notes.register')); ?>" method="post">
...
</html><?php /**PATH C:\Users\Lenovo\OneDrive\Bureau\pfa_v2-pfav2\resources\views/notes/register-user.blade.php ENDPATH**/ ?>